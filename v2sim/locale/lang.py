...
class Lang:    
    ...
    ERROR_GS_FILE_NOT_FOUND = "Error: Gas station file not found."
    ERROR_GRID_FILE_NOT_SPECIFIED = "Error: Power grid file not specified."
    ...
    WARN_MAIN_NO_DAEMON_MEANINGLESS = "Warning: 'no-daemon' option is meaningless when 'show' is False."
    ...
    INFO_GS = "  Gas Station: {0}, Number = {1}"
    ...
    STATIONHUB_INVALID_ELEMENT = "Elements in csList must be FCS or SCS"
    STATIONHUB_MIXED_ELEMENT = "Elements in csList must be all FCS or all SCS. Set 'ALLOW_MIXED_CSTYPE_IN_CSLIST' to 'True' to remove this restriction."
    STATIONHUB_INVALID_TAG = "Invalid tag {} when initializing CSList with xml file."
    STATIONHUB_PBUY_NOT_SPECIFIED = "Purchase price not specified when initializing CSList with xml file."
    STATIONHUB_BIND_NOT_SPECIFIED = "Bind attribute not specified when initializing CSList with xml file."
    STATIONHUB_INVALID_INIT_PARAM = "Invalid initialization parameter type for CSList."
    STATIONHUB_KDTREE_DISABLED = "    KDTree is disabled due to invalid CS position. Cannot find nearest CS."
    HUB_CS_NOT_EXIST = "Station {0} does not exist in the hub."

    CPROC_ARRIVE = "Arrival"
    CPROC_ARRIVE_CS = "Fast Charging Start"
    CPROC_ARRIVE_GS = "Gas Station Arrival"
    CPROC_DEPART = "Departure"
    CPROC_DEPART_DELAY = "Departure Delayed"
    CPROC_DEPART_CS = "Fast Charging Done"
    CPROC_DEPART_GS = "Gas Station Departure"
    ...
    CPROC_INFO_ARRIVE_GS = "Vehicle {0} arrive at gas station {1}."
    ...
    CPROC_INFO_DEPART_GS = "Vehicle {0} finished refueling at gas station {1}, continuing the trip to {2}."
...
'''
    ...
    NO_AVAILABLE_GS = "No gas station is available at this time, please check the configuration."
    ...
    INVALID_PLUGIN_STATES = "Invalid plugin states in saved state."
    DEPART_TIME_PASSED = "Vehicle {0}'s depart time {1} has already passed the current time {2}."

    VEH_ALREADY_EXISTS = "Vehicle {0} already exists."
    CS_ALREADY_EXISTS = "Charging station {0} already exists."
    STATIONHUB_INVALID_OWNERS_TAG = "Owners tag {0} is invalid."
    STATIONHUB_INVALID_TYPE = "Invalid station type: {0}"
    STATIONHUB_DUPLICATE_PBUY = "Duplicate pbuy tag when initializing StationHub with xml file."
    STATIONHUB_DUPLICATE_PSELL = "Duplicate psell tag when initializing StationHub with xml file."
    STATIONHUB_DUPLICATE_OFFLINE = "Duplicate offline tag when initializing StationHub with xml file."
    STATIONHUB_DUPLICATE_OWNERS = "Duplicate owners tag when initializing StationHub with xml file."
    VEH_TYPE_NOT_SUPPORTED = "Vehicle {0} type {1} not supported in this operation."
