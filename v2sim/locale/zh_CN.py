class _locale:
    ...
    CPROC_ARRIVE = "到达"
    CPROC_ARRIVE_CS = "开始快充"
    CPROC_ARRIVE_GS = "开始加油"
    CPROC_DEPART = "出发"
    CPROC_DEPART_DELAY = "延误"
    CPROC_DEPART_CS = "快充完成"
    CPROC_DEPART_GS = "加油完成"
    ...
    CPROC_INFO_ARRIVE_GS = "车辆{0}到达加油站{1}."
    ...
    CPROC_INFO_DEPART_GS = "车辆{0}在加油站{1}加完油, 继续前往{2}."
...
'''
    ...
    NO_AVAILABLE_GS = "目前没有可用加油站，请调整配置."
